...
# +++ Last update: 18 January 2022 
 ...
 png("$pathdir/output/gui_plot.png", width = 391, height = 520, type='cairo')

 #open data
 dinsol1=read.table("$pathdir/output/insolation.txt", header=T, dec=".", sep="") 
 names(dinsol1) 
 attach(dinsol1) 

 #open data
 dinsol3 = read.table("$pathdir/output/summary.txt", header= T, dec=".", sep="") 
 names(dinsol3) 
 attach(dinsol3)
...
if (ORBITAL == 1) {
  ...
  if (NDAYS == 365) {
      if (NY == 36)   dinsol2 = read.table("$pathdir/output/.0K/insolation_5dg_1_1.txt", header=T, dec=".", sep="") 
      if (NY == 45)   dinsol2 = read.table("$pathdir/output/.0K/insolation_4dg_1_1.txt", header=T, dec=".", sep="") 
      if (NY == 60)   dinsol2 = read.table("$pathdir/output/.0K/insolation_3dg_1_1.txt", header=T, dec=".", sep="") 
      if (NY == 90)   dinsol2 = read.table("$pathdir/output/.0K/insolation_2dg_1_1.txt", header=T, dec=".", sep="") 
      if (NY == 180)  dinsol2 = read.table("$pathdir/output/.0K/insolation_1dg_1_1.txt", header=T, dec=".", sep="") 
      if (NY == 360)  dinsol2 = read.table("$pathdir/output/.0K/insolation_0.5dg_1_1.txt", header=T, dec=".", sep="") 
  } else {
      if (NY == 36)   dinsol2 = read.table("$pathdir/output/.0K/insolation_5dg_2_1.txt", header=T, dec=".", sep="") 
      if (NY == 45)   dinsol2 = read.table("$pathdir/output/.0K/insolation_4dg_2_1.txt", header=T, dec=".", sep="") 
      if (NY == 60)   dinsol2 = read.table("$pathdir/output/.0K/insolation_3dg_2_1.txt", header=T, dec=".", sep="") 
      if (NY == 90)   dinsol2 = read.table("$pathdir/output/.0K/insolation_2dg_2_1.txt", header=T, dec=".", sep="") 
      if (NY == 180)  dinsol2 = read.table("$pathdir/output/.0K/insolation_1dg_2_1.txt", header=T, dec=".", sep="") 
      if (NY == 360)  dinsol2 = read.table("$pathdir/output/.0K/insolation_0.5dg_2_1.txt", header=T, dec=".", sep="") 
  } 

} else if (ORBITAL == 2) {

  if (NDAYS == 365) {
      if (NY == 36)   dinsol2 = read.table("$pathdir/output/.0K/insolation_5dg_1_2.txt", header=T, dec=".", sep="") 
      if (NY == 45)   dinsol2 = read.table("$pathdir/output/.0K/insolation_4dg_1_2.txt", header=T, dec=".", sep="") 
      if (NY == 60)   dinsol2 = read.table("$pathdir/output/.0K/insolation_3dg_1_2.txt", header=T, dec=".", sep="") 
      if (NY == 90)   dinsol2 = read.table("$pathdir/output/.0K/insolation_2dg_1_2.txt", header=T, dec=".", sep="") 
      if (NY == 180)  dinsol2 = read.table("$pathdir/output/.0K/insolation_1dg_1_2.txt", header=T, dec=".", sep="") 
      if (NY == 360)  dinsol2 = read.table("$pathdir/output/.0K/insolation_0.5dg_1_2.txt", header=T, dec=".", sep="") 
  } else {
      if (NY == 36)   dinsol2 = read.table("$pathdir/output/.0K/insolation_5dg_2_2.txt", header=T, dec=".", sep="") 
      if (NY == 45)   dinsol2 = read.table("$pathdir/output/.0K/insolation_4dg_2_2.txt", header=T, dec=".", sep="") 
      if (NY == 60)   dinsol2 = read.table("$pathdir/output/.0K/insolation_3dg_2_2.txt", header=T, dec=".", sep="") 
      if (NY == 90)   dinsol2 = read.table("$pathdir/output/.0K/insolation_2dg_2_2.txt", header=T, dec=".", sep="") 
      if (NY == 180)  dinsol2 = read.table("$pathdir/output/.0K/insolation_1dg_2_2.txt", header=T, dec=".", sep="") 
      if (NY == 360)  dinsol2 = read.table("$pathdir/output/.0K/insolation_0.5dg_2_2.txt", header=T, dec=".", sep="") 
  } 

} else if (ORBITAL == 3) {

  if (NDAYS == 365) {
      if (NY == 36)   dinsol2 = read.table("$pathdir/output/.0K/insolation_5dg_1_3.txt", header=T, dec=".", sep="") 
      if (NY == 45)   dinsol2 = read.table("$pathdir/output/.0K/insolation_4dg_1_3.txt", header=T, dec=".", sep="") 
      if (NY == 60)   dinsol2 = read.table("$pathdir/output/.0K/insolation_3dg_1_3.txt", header=T, dec=".", sep="") 
      if (NY == 90)   dinsol2 = read.table("$pathdir/output/.0K/insolation_2dg_1_3.txt", header=T, dec=".", sep="") 
      if (NY == 180)  dinsol2 = read.table("$pathdir/output/.0K/insolation_1dg_1_3.txt", header=T, dec=".", sep="") 
      if (NY == 360)  dinsol2 = read.table("$pathdir/output/.0K/insolation_0.5dg_1_3.txt", header=T, dec=".", sep="") 
  } else {
      if (NY == 36)   dinsol2 = read.table("$pathdir/output/.0K/insolation_5dg_2_3.txt", header=T, dec=".", sep="") 
      if (NY == 45)   dinsol2 = read.table("$pathdir/output/.0K/insolation_4dg_2_3.txt", header=T, dec=".", sep="") 
      if (NY == 60)   dinsol2 = read.table("$pathdir/output/.0K/insolation_3dg_2_3.txt", header=T, dec=".", sep="") 
      if (NY == 90)   dinsol2 = read.table("$pathdir/output/.0K/insolation_2dg_2_3.txt", header=T, dec=".", sep="") 
      if (NY == 180)  dinsol2 = read.table("$pathdir/output/.0K/insolation_1dg_2_3.txt", header=T, dec=".", sep="") 
      if (NY == 360)  dinsol2 = read.table("$pathdir/output/.0K/insolation_0.5dg_2_3.txt", header=T, dec=".", sep="") 
  } 
 ...
 #Blue to red
 MyDivergent1<-colorRampPalette(c("#1984c5", "#22a7f0", "#63bff0", "#a7d5ed", "#e2e2e2", "#e1a692", "#de6e56", "#e14b31", "#c23728"), bias=1)
							  
 #Pink Foam
 MyDivergent2<-colorRampPalette(c("#54bebe", "#76c8c8", "#98d1d1", "#badbdb", "#dedad2", "#e4bcad", "#df979e", "#d7658b", "#c80064"), bias=1)
 ...
 image(times,lat,t(dif),col = MyDivergent2(100), ylab = "Latitude",
